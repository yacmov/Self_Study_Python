# 1. Game over when all balls are eliminated (Success)
# 2. If the character touches the ball, the game ends (failed)
# 3. Game ends when the time limit exceeds 90 seconds (failed)
...
# Background
background = pygame.image.load(os.path.join(image_path, "New_Background.png"))

# Stage 
stage = pygame.image.load(os.path.join(image_path, "New_Stage.png"))
stage_size = stage.get_rect().size
stage_height = stage_size[1]

# Character
character = pygame.image.load(os.path.join(image_path, "New_Character.png"))
...
# make Weapon
weapon = pygame.image.load(os.path.join(image_path, "New_Weapon.png"))
...
ball_images = [
    pygame.image.load(os.path.join(image_path, "New_Ballon1.png")),
    pygame.image.load(os.path.join(image_path, "New_Ballon2.png")),
    pygame.image.load(os.path.join(image_path, "New_Ballon3.png")),
    pygame.image.load(os.path.join(image_path, "New_Ballon4.png"))]
...
# Game msg 
# TimeOut, Mission complete, Gave over
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            continue # if inside "for" isn't match run this one
        break # if inside for is matched and break run this one as well for outside "for" 
    ...
    # Success to remove all the balls
    if len(balls) == 0:
